      ...
      child: SideMenu(
          ...
          menu: Column(
            ...
            children: [
              UserAccountsDrawerHeader(
                ...
                accountEmail:
                    appText(title: "testapp@gmail.com", fontSize: 2.h),
              ),
              Padding(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              title: appText(
                  title: AppSatring.wikilist, color: AppColor.whiteColor),
                  ...
                  if (state.articlelist.isEmpty) {
                    return Column(
                      ...
                      children: [
                        ...
                        Center(
                          child: appText(
                              title: "No Article", color: AppColor.grey),
                        ),
                      ],
                    );
                  } else {
